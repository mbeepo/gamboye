...
impl Instruction {
    pub fn from_byte_short(byte: u8) -> Option<Self> {
        match byte {
            ...
            0x1B => Some(Self::DECW(WordArithmeticTarget::DE)),
            ...
            0x2B => Some(Self::DECW(WordArithmeticTarget::HL)),
            ...
            0x3B => Some(Self::DECW(WordArithmeticTarget::SP)),
            ...
            0xE7 => Some(Self::RST(4)),
            0xE8 => Some(Self::ADDSP),
            0xE9 => Some(Self::JPHL),
